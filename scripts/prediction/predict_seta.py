...
image_path = r'E:\A_workbench\A-lab\Unet\Unet_complit\data\ConvertedImages\00024.png'  # 需要进行预测的图像文件路径
output_path = r'E:\A_workbench\A-lab\Unet\Unet_complit\data\00022_predict_2.png'  # 保存预测结果的文件路径
