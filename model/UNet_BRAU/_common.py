...
# DWConv：实现深度卷积，用于捕获局部空间特征。
# Attention：标准多头自注意力机制，捕获全局特征。
# AttentionLePE：在注意力机制中加入可学习的位置编码，提高模型对位置信息的敏感度。
# nchwAttentionLePE：适用于 NCHW 格式数据的注意力机制，功能与 AttentionLePE 类似。
